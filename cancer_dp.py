...
def manual_k_means(data, k, num_iterations=100):
    np.random.seed(0)
...
kmeans_labels = manual_k_means(data_scaled, num_clusters)

# Manual K-Medoids clustering
def manual_k_medoids(data, k, num_iterations=100):
    np.random.seed(0)
...
kmedoids_labels = manual_k_medoids(data_scaled, num_clusters)
